...
#define FLAG_SYS_SET_TRAINER_CARD_PROFILE                           (SYS_FLAGS + 0x33)
#define FLAG_SYS_ON_CYCLING_ROAD                                    (SYS_FLAGS + 0x34)
#define FLAG_SYS_NOT_SOMEONES_PC                                    (SYS_FLAGS + 0x35)
...
#define FLAG_WORLD_MAP_VIOLET_CITY                                  (SYS_FLAGS + 0xC5)
#define FLAG_WORLD_MAP_AZALEA_TOWN                                  (SYS_FLAGS + 0xC6)
#define FLAG_WORLD_MAP_GOLDENROD_CITY                               (SYS_FLAGS + 0xC7)
#define FLAG_WORLD_MAP_ECRUTEAK_CITY                                (SYS_FLAGS + 0xC8)
#define FLAG_WORLD_MAP_OLIVINE_CITY                                 (SYS_FLAGS + 0xC9)
#define FLAG_WORLD_MAP_CIANWOOD_CITY                                (SYS_FLAGS + 0xCA)
#define FLAG_WORLD_MAP_MAHOGANY_TOWN                                (SYS_FLAGS + 0xCB)
#define FLAG_WORLD_MAP_BLACKTHORN_CITY                              (SYS_FLAGS + 0xCC)
#define FLAG_WORLD_MAP_LAKE_OF_RAGE                                 (SYS_FLAGS + 0xCD)
#define FLAG_WORLD_MAP_MT_SILVER                                    (SYS_FLAGS + 0xCE)
#define FLAG_WORLD_MAP_DARK_CAVE                                    (SYS_FLAGS + 0xCF)
#define FLAG_WORLD_MAP_SPROUT_TOWER_1F                              (SYS_FLAGS + 0xD0)
#define FLAG_WORLD_MAP_UNION_CAVE_1F                                (SYS_FLAGS + 0xD1)
#define FLAG_WORLD_MAP_SLOWPOKE_WELL_1F                             (SYS_FLAGS + 0xD2)
#define FLAG_WORLD_MAP_ILEX_FOREST                                  (SYS_FLAGS + 0xD3)
#define FLAG_WORLD_MAP_NATIONAL_PARK                                (SYS_FLAGS + 0xD4)
#define FLAG_WORLD_MAP_BURNED_TOWER_1F                              (SYS_FLAGS + 0xD5)
#define FLAG_WORLD_MAP_BELL_TOWER_1F                                (SYS_FLAGS + 0xD6)
#define FLAG_WORLD_MAP_WHIRL_ISLANDS_1F                             (SYS_FLAGS + 0xD7)
#define FLAG_WORLD_MAP_MT_MORTAR_1F                                 (SYS_FLAGS + 0xD8)
#define FLAG_WORLD_MAP_ICE_PATH_1F                                  (SYS_FLAGS + 0xD9)
#define FLAG_WORLD_MAP_DRAGONS_DEN_1F                               (SYS_FLAGS + 0xDA)
#define FLAG_WORLD_MAP_TOHJO_FALLS                                  (SYS_FLAGS + 0xDB)
#define FLAG_WORLD_MAP_MT_SILVER_CAVE                               (SYS_FLAGS + 0xDC)
#define FLAG_WORLD_MAP_CLIFF_CAVE                                   (SYS_FLAGS + 0xDD)
#define FLAG_WORLD_MAP_EMBEDDED_TOWER                               (SYS_FLAGS + 0xDE)
#define FLAG_WORLD_MAP_ROUTE32_POKEMON_CENTER_1F                    (SYS_FLAGS + 0xDF)
