...
#define STATUS3_ROOSTED                 (1 << 21)
#define STATUS3_ALWAYS_CRIT             (1 << 22 | 1 << 23)
#define STATUS3_ALWAYS_CRIT_TURN(num)   (((num) << 22) & STATUS3_ALWAYS_CRIT)
...
#define SIDE_STATUS_STEALTH_ROCK         (1 << 2)
#define SIDE_STATUS_TOXIC_SPIKES         (1 << 3)
#define SIDE_STATUS_SPIKES               (1 << 4)
#define SIDE_STATUS_SAFEGUARD            (1 << 5)
#define SIDE_STATUS_FUTUREATTACK         (1 << 6)
#define SIDE_STATUS_STICKY_WEB           (1 << 7)
#define SIDE_STATUS_MIST                 (1 << 8)
#define SIDE_STATUS_SPIKES_DAMAGED       (1 << 9)
#define SIDE_STATUS_STEALTH_ROCK_DAMAGED (1 << 10)
#define SIDE_STATUS_TOXIC_SPIKES_DAMAGED (1 << 11)
#define SIDE_STATUS_STICKY_WEB_DAMAGED   (1 << 12)
#define SIDE_STATUS_LUCKY_CHANT          (1 << 13)
#define SIDE_STATUS_TAILWIND             (1 << 14)
#define SIDE_STATUS_WIDE_GUARD           (1 << 15)
#define SIDE_STATUS_QUICK_GUARD          (1 << 16)
#define SIDE_STATUS_RAINBOW              (1 << 17)
#define SIDE_STATUS_SWAMP                (1 << 18)
#define SIDE_STATUS_FIRE_SEA             (1 << 19)
#define SIDE_STATUS_AURORA_VEIL          (1 << 20)
...
#define B_WEATHER_STRONG_WIND		  (1 << 1)  // for delta stream
...
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WIND)
