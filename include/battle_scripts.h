...
extern const u8 BattleScript_StickyWebOnAttacker[];
extern const u8 BattleScript_StickyWebOnTarget[];
extern const u8 BattleScript_ToxicSpikesOnAttacker[];
...
extern const u8 BattleScript_TargetAwaken[];
...
extern const u8 BattleScript_StickyWebOnFaintedBattler[];
