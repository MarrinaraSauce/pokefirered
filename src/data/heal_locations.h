static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_NEW_BARK_TOWN - 1] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 16, 7},
    [SPAWN_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 20, 13},
    [SPAWN_VIOLET_CITY - 1] = {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), 20, 6},
    [SPAWN_ROUTE32 - 1] = {MAP_GROUP(ROUTE32), MAP_NUM(ROUTE32), 12, 9},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_ROUTE32 - 1] = {MAP_GROUP(ROUTE32), MAP_NUM(ROUTE32)},
};
