...
static const u8 sPlusDescription[] = _("Powers up with Plus or Minus.");
...
static const u8 sTangledFeetDescription[] = ("Ups evasion when confused.");
static const u8 sMotorDriveDescription[] = _("Ups Speed if hit by electricity.");
static const u8 sRivalryDescription[] = _("Powers up against the same gender.");
...
static const u8 sAngerPointDescription[] = _("Maxes Attack when critically hit.");
static const u8 sUnburdenDescription[] = _("Boosts Speed when losing an item.");
static const u8 sSimpleDescription[] = _("Doubles stat changes.");
static const u8 sDrySkinDescription[] = _("Absorbs water, hurt by fire.");
static const u8 sDownloadDescription[] = _("Boosts attack or Sp. Attack.");
static const u8 sIronFistDescription[] = _("Powers up punches.");
static const u8 sPoisonHealDescription[] = _("Poison restores HP.");
static const u8 sAdaptabilityDescription[] = _("Powers up moves of the same type.");
static const u8 sSkillLinkDescription[] = _("Maximizes multihit attacks.");
static const u8 sHydrationDescription[] = _("Heals status in rain.");
static const u8 sSolarPowerDescription[] = _("Boosts Sp. Attack but lowers HP in sun.");
static const u8 sQuickFeetDescription[] = _("Ups Speed if suffering.");
static const u8 sNormalizeDescription[] = _("Attacks become normal.");
...
static const u8 sNoGuardDescription[] = _("All attacks always hit.");
static const u8 sStallDescription[] = _("Always moves last.");
static const u8 sTechnicianDescription[] = _("Powers up weak moves.");
static const u8 sLeafGuardDescription[] = _("Heals status in sun.");
static const u8 sMoldBreakerDescription[] = _("Ignores other abilities.");
static const u8 sSuperLuckDescription[] = _("Critically hits more often.");
static const u8 sAftermathDescription[] = _("Hurts foe when KO'd.");
static const u8 sAnticipationDescription[] = _("Senses foe's dangerous moves.");
static const u8 sForewarnDescription[] = _("Senses an opponent's move.");
static const u8 sUnawareDescription[] = _("Ignores foe's stat changes.");
static const u8 sTintedLensDescription[] = _("Boosts ineffective moves.");
static const u8 sFilterDescription[] = _("Weakens super-effective damage.");
static const u8 sScrappyDescription[] = _("Attacks can hit Ghost-type Pokémon.");
...
static const u8 sSolidRockDescription[] = _("Weakens super-effective damage.");
static const u8 sHoneyGatherDescription[] = _("May pick up honey.");
static const u8 sFriskDescription[] = _("Sees opponent's item.");
static const u8 sRecklessDescription[] = _("Ups moves with recoil.");
static const u8 sPickpocketDescription[] = _("Steals items from attackers.");
static const u8 sSheerForceDescription[] = _("Trades added effects for power.");
static const u8 sContraryDescription[] = _("Stat changes are inverted.");
static const u8 sUnnerveDescription[] = _("Foes are too nervous to eat.");
static const u8 sDefiantDescription[] = _("Boosts Attack when stats are lowered.");
static const u8 sCursedBodyDescription[] = _("Disables the foe on contact.");
static const u8 sHealerDescription[] = _("Cures allies' status problems.");
static const u8 sFriendGuardDescription[] = _("Reduces damage dealt to allies.");
static const u8 sWeakArmorDescription[] = _("Trades Defense for Speed when hit.");
...
static const u8 sMultiscaleDescription[] = _("Reduces damage while at full HP.");
static const u8 sToxicBoostDescription[] = _("Ups Attack when poisoned.");
static const u8 sHarvestDescription[] = _("May replace a used berry.");
static const u8 sTelepathyDescription[] = _("Dodges allies' attacks.");
static const u8 sMoodyDescription[] = _("Raises and lowers random stats.");
static const u8 sOvercoatDescription[] = _("Protection from weather and spores.");
static const u8 sPoisonTouchDescription[] = _("May poison when making contact.");
static const u8 sRegeneratorDescription[] = _("Gains HP upon switching out.");
...
static const u8 sWonderSkinDescription[] = _("May evade status moves.");
static const u8 sAnalyticDescription[] = _("Boosts power when moving last.");
static const u8 sImposterDescription[] = _("Transforms into the Pokémon it's facing.");
static const u8 sInfiltratorDescription[] = _("Passes through the foe's barrier.");
static const u8 sMoxieDescription[] = _("Boosts Attack after KO-ing a foe.");
static const u8 sJustifiedDescription[] = _("Boosts Attack when hit by Dark-type.");
static const u8 sRattledDescription[] = _("Some move types scare and boost Speed.");
static const u8 sMagicBounceDescription[] = _("Reflects status moves.");
static const u8 sSapSipperDescription[] = _("Powers up if hit by grass.");
static const u8 sPranksterDescription[] = _("Status moves go first.");
static const u8 sSandForceDescription[] = _("Ups Attack in a sandstorm.");
static const u8 sProteanDescription[] = _("Becomes the type of its move.");
static const u8 sBulletproofDescription[] = _("Avoids ball and bomb moves.");
static const u8 sCompetitiveDescription[] = _("Boosts Sp. Attack when stats are lowered.");
...
static const u8 sToughClawsDescription[] = ("Boosts contact moves.");
...
static const u8 sParentalBondDescription[] = _("Parent and child attack together.");
static const u8 sPrimordialSeaDescription[] = _("Affects weather and nullifies fire.");
static const u8 sDesolateLandDescription[] = _("Affects weather and nullifies water.");
static const u8 sDeltaStreamDescription[] = _("Affects weather and reduces Flying's weaknesses.");
static const u8 sNeutralizingGasDescription[] = _("Nullifies other abilities.");
static const u8 sWindRiderDescription[] = _("Powers up if hit by wind.");
static const u8 sCudChewDescription[] = _("Eats berries twice.");
static const u8 sSharpnessDescription[] = _("Boosts slicing moves.");
static const u8 sArmorTailDescription[] = ("Avoids priority moves.");
static const u8 sSurgeSurferDescription[] = ("Boosts Speed in electric terrain.");
...
static const u8 sTanglingHairDescription[] = _("Slows foes who make contact.");
static const u8 sFurCoatDescription[] = _("Raises Defense.");
static const u8 sSteelySpiritDescription[] = ("Boosts Steel moves.");
static const u8 sGalvanizeDescription[] = _("Normal moves become Electric.");
static const u8 sPastelVeilDescription[] = _("Protects its team from Poison.");
static const u8 sQuickDrawDescription[] = _("Occasionally goes first.");
static const u8 sCuriousMedicineDescription[] = _("Removes allies' stat changes.");
static const u8 sPowerOfAlchemyDescription[] = _("Copies a fallen ally's ability.");
static const u8 sMistySurgeDescription[] = _("Summons misty terrain in battle.");
static const u8 sScreenCleanerDescription[] = _("Removes Light Screen and Reflect.");
static const u8 sBerserkDescription[] = _("Raises Sp. Attack at low HP.");
static const u8 sMindsEyeDescription[] = _("Hits Ghosts and evasive targets.");
static const u8 sPerishBodyDescription[] = _("Attacker and user faint in 3 turns when hit.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_POWER_OF_ALCHEMY] = sPowerOfAlchemyDescription,
