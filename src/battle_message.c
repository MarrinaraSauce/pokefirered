...
static const u8 sText_PkmnLostType[] = _("{B_ATK_NAME_WITH_PREFIX} lost its\n{B_BUFF1} type!");
...
static const u8 sText_StickyWebScattered[] = _("A sticky net was woven around\nthe opponent's side!");
static const u8 sText_PkmnHurtByStickyWeb[] = _("The Sticky Web lowered\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Speed!");
...
static const u8 sText_PkmnHurtByIts[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt by its\n{B_ATK_ABILITY}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
	...
	[STRINGID_PKMNLOSTTYPE - BATTLESTRINGS_TABLE_START]                  = sText_PkmnLostType,
    ...
    [STRINGID_STICKYWEBSCATTERED - BATTLESTRINGS_TABLE_START]            = sText_StickyWebScattered,
    [STRINGID_PKMNHURTBYSTICKYWEB - BATTLESTRINGS_TABLE_START]           = sText_PkmnHurtByStickyWeb,
    [STRINGID_TOXICSPIKESSCATTERED - BATTLESTRINGS_TABLE_START]          = sText_ToxicSpikesScattered,
    [STRINGID_PKMNHURTBYTOXICSPIKES - BATTLESTRINGS_TABLE_START]         = sText_PkmnHurtByToxicSpikes,
    [STRINGID_STEALTHROCKSCATTERED - BATTLESTRINGS_TABLE_START]          = sText_StealthRockScattered,
