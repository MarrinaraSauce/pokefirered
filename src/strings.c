...
const u8 gText_FreshWater_200[] = _("Fresh Watter{CLEAR_TO 0x57}{FONT_SMALL}¥200");
...
const u8 gText_TmCase[] = _("TM CAase");
...
const u8 gText_ThreeIsland[] = _("Tree Island");
...
const u8 gText_PickSwitchCancel[] = _("{DPAD_UPDOWN}Pick {DPAD_LEFTRIGHT}witch {A_BUTTON}{B_BUTTON}Cancel");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("Pokémon");
